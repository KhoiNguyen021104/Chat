...
export default function InboxRes() {
      ...
      >
        ...
        <div className='sticky flex items-center flex-row justify-between bg-black/20  opacity-90 shadow-2xl  px-5 py-3'>
          <div className='flex items-center'>
            ...
            <div>
              <h5 className='font-medium text-white'>Henry Dholi</h5>
        ...
        <div className='max-h-full space-y-3.5 flex flex-col gap-2 overflow-auto no-scrollbar px-5 py-7 grow'>
          <TextMessage
            author={"Hoang Van Vu"}
            timestamp={"9:01AM"}
            content={"Thông minh vô cùng tận"}
            incoming={true}
            read_receipt={"sent"}
          />
          <TextMessage
            timestamp={"9:13AM"}
            content={"https://www.youtube.com/watch?v=mC8MKvdy9yE"}
            incoming={false}
          ...
          <form className='flex items-center justify-between space-x-4.5'>
            <div className='relative w-full'>
              <input
                ...
                className='h-12 w-full rounded-2xl border  pl-5 pr-19 text-black placeholder-body outline-none focus:border-primary bg-[#2e2e2e]'
              />
